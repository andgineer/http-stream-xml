...
|-------------------------------------------------------- | -------: | -------: | ------: | --------: |
| src/http\_stream\_xml/entrez.py                         |      127 |       26 |     80% |186-191, 194-196, 202-213, 221, 244, 250-251, 253-257, 270-288 |
| src/http\_stream\_xml/examples/http\_stream\_example.py |       19 |       15 |     21% |13-33, 37-38 |
| src/http\_stream\_xml/socket\_stream.py                 |       51 |       17 |     67% |49, 56-57, 61-62, 66-79 |
| src/http\_stream\_xml/version.py                        |        1 |        1 |      0% |         1 |
| src/http\_stream\_xml/xml\_stream.py                    |       41 |        0 |    100% |           |
| **TOTAL**                                               |  **239** |   **59** | **75%** |           |
